		...
		<div className="contents">
			<div className="w-2/3 m-2 md:m-10 md:px-10">
				...
				<div className="my-4 border-gray-400 rounded-3xl border-1 p-6">
					...
					<div className={pointHistoriesData?.length ? `pl-3 pr-2 contents-area-payment flex flex-col` : `pl-3 pr-2 flex flex-col`}>
						...
						{activeTab === PaymentHistoriesType.REVENUE && (
							<div className="flex border-t mx-2 mt-3 pt-3 justify-between items-center contents-area-payment-total">
