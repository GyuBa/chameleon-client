            ...
            <div className="py-4">
              ...
              <div className="gap-4 grid md:py-10 md:px-5 md:my-2 md:grid-cols-2">
                ...
                <div>
                  ...
                  <div className="md:p-10 rounded border border-solid border-gray-300 text-center item-center">
                    <img style={{width: '60px'}} className="object-cover w-full inline-block align-middle" src={tabsData[activeTabIndex].img}/>
