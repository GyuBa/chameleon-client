...
export default function Model3() {
  ...
  return (
    <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white dark:bg-secondary-dark-bg rounded-3xl">
      <Header category="Model" title="Model3"/>
      <div className="mb-10 text-black dark:text-white">Model3 description</div>
      <div className="my-4 md:p-5 rounded-3xl bg-slate-300 dark:bg-slate-300">
        ...
        <section className="container">
          <div {...getRootProps({className: 'dropzone'})}>
            <input {...getInputProps()} />
            <p className="inline-block px-5 py-3 text-gray-500 hover:text-gray-700 hover:text-lg cursor-pointer">Drag 'n' drop some files here, or
